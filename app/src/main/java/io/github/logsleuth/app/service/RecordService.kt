...
class RecordService : Service() {
    ...
    companion object {
        const val ACTION_START = "io.github.logsleuth.app.action.START_RECORDING"
        const val ACTION_STOP = "io.github.logsleuth.app.action.STOP_RECORDING"
        const val ACTION_BOOKMARK = "io.github.logsleuth.app.action.BOOKMARK"
